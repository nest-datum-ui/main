...
let Drop = () => {
	const entityId = useSelector(selectorMainExtract([ 'dialog', MAIL_PATH_REPORT, 'entityId' ]));
	const formLoader = useSelector(selectorMainExtract([ 'api', 'form', MAIL_PATH_REPORT, 'loader' ]));
	const listLoader = useSelector(selectorMainExtract([ 'api', 'list', MAIL_PATH_REPORT, 'loader' ]));
	const onDrop = React.useCallback((e) => actionApiFormDrop(MAIL_PATH_REPORT, entityId)(), [
		entityId,
	]);

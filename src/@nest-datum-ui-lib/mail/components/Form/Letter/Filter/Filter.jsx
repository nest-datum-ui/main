...
import FormFilterLetterStatus from './Status';
		...
		<Box 
			...
			<Grid
				...
				<Grid
					...
					lg={3}
					xl={2}>
					<FormFilterIsDeleted storeName="mailLetterList" />
				</Grid>
				<Grid
					item
					xs={12}
					...
					lg={3}
					xl={2}>
					<FormFilterIsNotDelete storeName="mailLetterList" />
				</Grid>
			</Grid>
		</Box>
	</React.Fragment>;

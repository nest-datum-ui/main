...
import MailSelectReportStatusMultiple from '@nest-datum-ui-lib/mail/components/Select/Report/Status/Multiple';
...
let Report = ({
	...
	const dataLength = useSelector(selectorMainExtract([ 'api', 'list', MAIL_PATH_REPORT_STATUS, 'data', 'length' ]));
	const value = (dataLength > 0)
		? utilsUrlItemFilterGetId(search, MAIL_PATH_REPORT_STATUS, 'reportStatusId')
		: [];
	...
	return <React.Fragment>
		<Grid
			...
			<Grid
				item
				xs={true}>
				<MailSelectReportStatusMultiple 
					label="Status"
					name={id}

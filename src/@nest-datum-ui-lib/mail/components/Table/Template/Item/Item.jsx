...
import MailTypographyTemplateStatus from '@nest-datum-ui-lib/mail/components/Typography/Template/Status';
...
Item.propTypes = {
	...
	templateStatusId: PropTypes.string,

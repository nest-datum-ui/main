...
import { FORMS_PATH_CONTENT_OPTION } from '@nest-datum-ui-lib/forms/consts/path.js';
...
let Title = () => {
	...
	const isDeleted = useSelector(selectorMainExtract([ 'api', 'form', FORMS_PATH_CONTENT_OPTION, 'isDeleted' ]));

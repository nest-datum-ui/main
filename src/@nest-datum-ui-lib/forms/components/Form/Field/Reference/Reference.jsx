...
let Reference = ({ storeName }) => {
	...
	const fieldId = useSelector(selectorMainExtract([ 'api', 'form', entityId, 'fieldId' ]));
	const errorFieldId = useSelector(selectorMainExtract([ 'api', 'form', entityId, 'errors', 'fieldId' ]));
	...
	const onChangeFieldId = React.useCallback((e) => {
		actionApiFormProp(entityId, 'fieldId', e.target.value)();
	}, [
		entityId,
	]);

...
let Option = ({ 
	...
	const formId = useSelector(selectorMainExtract([ 'api', 'form', storeName, 'formId' ]));
	const errorFormId = useSelector(selectorMainExtract([ 'api', 'form', storeName, 'errors', 'formId' ]));
	...
	const onChangeFormId = React.useCallback((e) => {
		actionApiFormProp(storeName, 'formId', e.target.value)();
	}, [
		storeName,
	]);

...
let Options = ({
	...
	const onDelete = React.useCallback((formId) => (e) => {
		actionDialogOpen('formsFormReferenceDrop', {
			formId,
			optionId: entityId,
							...
							{data.map((item, index) => {
								return <TableRow key={item.id}>
									...
									<TableCell sx={{ width: '1%' }}>
										<IconButton onClick={onDelete(item['formFormOptions'][0]['id'])}>

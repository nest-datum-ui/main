...
let Drop = () => {
	const entityId = useSelector(selectorMainExtract([ 'dialog', LOGS_PATH_ERR, 'entityId' ]));
	const formLoader = useSelector(selectorMainExtract([ 'api', 'form', LOGS_PATH_ERR, 'loader' ]));
	const listLoader = useSelector(selectorMainExtract([ 'api', 'list', LOGS_PATH_ERR, 'loader' ]));
	const onDrop = React.useCallback((e) => actionApiFormDrop(LOGS_PATH_ERR, entityId)(), [
		entityId,
	]);

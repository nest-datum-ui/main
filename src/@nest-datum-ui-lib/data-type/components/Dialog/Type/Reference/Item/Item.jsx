...
import FormTypeReference from '@nest-datum-ui-lib/data-type/components/Form/Type/Reference';
...
let Item = ({
	...
	return <React.Fragment>
		<Dialog 
			...
			maxWidth="xs"
			id={id}
			title="Associate the current option with a type">
			<FormTypeReference storeName={storeName} />
		</Dialog>
	</React.Fragment>;
};

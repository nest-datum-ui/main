...
let Options = ({
	...
	const onDelete = React.useCallback((typeId) => (e) => {
		actionDialogOpen('dataTypeTypeReferenceDrop', {
			typeId,
			optionId: entityId,
							...
							{data.map((item, index) => {
								return <TableRow key={item.id}>
									...
									<TableCell sx={{ width: '1%' }}>
										<IconButton onClick={onDelete(item['typeTypeOptions'][0]['id'])}>
...
Options.defaultProps = {
	...
	storeName: 'dataTypeTypeOptionList',

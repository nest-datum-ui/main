...
import TableRoleOptions from '@nest-datum-ui-lib/sso/components/Table/Role/Options';
import DialogRoleReferenceItem from '@nest-datum-ui-lib/sso/components/Dialog/Role/Reference/Item';
import DialogRoleReferenceDrop from '@nest-datum-ui-lib/sso/components/Dialog/Role/Reference/Drop';
...
let SelectMultipleReference = ({
	...
	const onAdd = React.useCallback((e) => {
		actionDialogOpen('ssoRoleReferenceItem', { entityId })();
	}, [
		entityId,
	]);

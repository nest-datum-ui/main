...
import FormFilterAccessStatus from './Status';
		...
		<Box 
			...
			<Grid
				...
				<Grid
					...
					lg={3}
					xl={2}>
					<FormFilterIsDeleted storeName="ssoAccessList" />
				</Grid>
				<Grid
					item
					xs={12}
					...
					lg={3}
					xl={2}>
					<FormFilterIsNotDelete storeName="ssoAccessList" />
				</Grid>
			</Grid>
		</Box>
	</React.Fragment>;

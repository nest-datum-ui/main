...
let Access = ({
	...
	const name = useSelector(selectorMainExtract([ 'api', 'form', `${SSO_PATH_ACCESS}/${children}`, 'name' ]));
	...
	React.useEffect(() => () => {
		actionApiFormClear(`${SSO_PATH_ACCESS}/${children}`)();
		actionApiFormDropLoop(`${SSO_PATH_ACCESS}/${children}`);
	}, [
		children,
	]);

...
import FilesTypographyProvider from '@nest-datum-ui-lib/files/components/Typography/Provider';
import FilesTypographySystemStatus from '@nest-datum-ui-lib/files/components/Typography/System/Status';
	...
	return <React.Fragment>
		<TableRow key={id}>
			...
			<TableCell sx={{ minWidth: '15%' }}>
				<FilesTypographyProvider>
					{providerId}
				</FilesTypographyProvider>
			</TableCell>
			<TableCell sx={{ minWidth: '15%' }}>
				<FilesTypographySystemStatus>
					{systemStatusId}
				</FilesTypographySystemStatus>
			</TableCell>
			<TableCell sx={{ minWidth: '16%' }}>
...
Item.propTypes = {
	...
	systemStatusId: PropTypes.string,

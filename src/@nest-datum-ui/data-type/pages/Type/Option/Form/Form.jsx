...
import SelectTypeMultipleReference from '@nest-datum-ui/data-type/components/Select/Type/Multiple/Reference';
...
let Form = () => {
	...
	React.useEffect(() => {
		actionBreadcrumbsListSet('app', [{
			...
			key: `/data-type/tpye/options/${entityId}`,
			text: (entityId === '0')
				? 'Create new option'
				: <span
					style={{
	...
	return <React.Fragment>
		...
		<FormOption
			...
			selectMultipleReferenceComponent={(props) => {
				return <SelectTypeMultipleReference { ...props } />;
			}} />
		<DialogOptionDrop
			withAccessToken
			storeName="dataTypeTypeOptionsList"

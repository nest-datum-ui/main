...
import SelectType from '@nest-datum-ui/data-type/components/Select/Type';
...
let Reference = ({ storeName }) => {
	...
	const typeId = useSelector(selectorMainExtract([ 'api', 'form', entityId, 'typeId' ]));
	const errorTypeId = useSelector(selectorMainExtract([ 'api', 'form', entityId, 'errors', 'typeId' ]));
	...
	const onChangeTypeId = React.useCallback((e) => {
		actionApiFormProp(entityId, 'typeId', e.target.value)();
	}, [
		entityId,
	]);

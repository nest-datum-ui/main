...
import FormFilterTypeStatus from './Status';
		...
		<Box 
			...
			<Grid
				...
				<Grid
					...
					lg={3}
					xl={2}>
					<FormFilterIsDeleted storeName="dataTypeTypeList" />
				</Grid>
				<Grid
					item
					xs={12}
					...
					lg={3}
					xl={2}>
					<FormFilterIsNotDelete storeName="dataTypeTypeList" />
				</Grid>
			</Grid>
		</Box>
	</React.Fragment>;

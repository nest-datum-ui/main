...
let Drop = ({
	...
	const relationId = useSelector(selectorMainExtract([ 'dialog', id, 'relationId' ]));
	...
	return <React.Fragment>
		<Dialog 
			...
			<DialogContentText>
				Are you sure you want to delete the current relation? This operation is irreversible and may compromise data integrity.
			</DialogContentText>
		</Dialog>
	</React.Fragment>;
};

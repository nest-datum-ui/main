...
import FormOptionFilterDataType from './DataType';
import FormOptionFilterIsMultiline from './IsMultiline';
import FormOptionFilterIsRequired from './IsRequired';
		...
		<Box 
			...
			<Grid
				...
				<Grid
					...
					lg={3}
					xl={2}>
					<FormOptionFilterDataType storeName={storeName} />
				</Grid>
				<Grid
					item
					xs={12}
					...
					lg={3}
					xl={2}>
					<FormOptionFilterIsMultiline storeName={storeName} />
				</Grid>
				<Grid
					item
					xs={12}
					...
					lg={3}
					xl={2}>
					<FormOptionFilterIsRequired storeName={storeName} />
				</Grid>
				<Grid
					item
					xs={12}
					...
					lg={3}
					xl={2}>
					<FormFilterIsDeleted storeName={storeName} />
				</Grid>
				<Grid
					item
					xs={12}
					...
					lg={3}
					xl={2}>
					<FormFilterIsNotDelete storeName={storeName} />
				</Grid>
			</Grid>
		</Box>
	</React.Fragment>;

...
import FormSettingFilterDataType from './DataType';
import FormSettingFilterIsRequired from './IsRequired';
		...
		<Box 
			...
			<Grid
				...
				<Grid
					...
					lg={3}
					xl={2}>
					<FormSettingFilterDataType storeName={storeName} />
				</Grid>
				<Grid
					item
					xs={12}
					...
					lg={3}
					xl={2}>
					<FormSettingFilterIsRequired storeName={storeName} />
				</Grid>
				<Grid
					item
					xs={12}

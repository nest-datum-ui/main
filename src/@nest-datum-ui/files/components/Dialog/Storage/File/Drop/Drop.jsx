...
let Drop = (props) => {
	...
	const entityId = useSelector(selectorMainExtract([ 'dialog', 'storage-file-drop', 'entityId' ]));
	...
	return <React.Fragment>
		<Dialog 
			...
			{state.loader
				? <Loader visible />
				: <DialogContentText>
					Вы уверены, что хотите удалить текущий файл? Эта операция безвозвратна и может нарушить целосность данных.
				</DialogContentText>}
		</Dialog>
	</React.Fragment>;
};

...
let Update = (props) => {
	...
	const entityId = useSelector(selectorMainExtract([ 'dialog', 'storage-folder-update', 'entityId' ]));
	const name = useSelector(selectorMainExtract([ 'dialog', 'storage-folder-update', 'name' ]));

...
import FormFilterSystemStatus from './Status';
		...
		<Box 
			...
			<Grid
				...
				<Grid
					...
					lg={3}
					xl={2}>
					<FormFilterIsDeleted storeName="filesSystemList" />
				</Grid>
				<Grid
					item
					xs={12}
					...
					lg={3}
					xl={2}>
					<FormFilterIsNotDelete storeName="filesSystemList" />
				</Grid>
			</Grid>
		</Box>
	</React.Fragment>;

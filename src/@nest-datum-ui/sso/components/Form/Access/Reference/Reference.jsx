...
import SelectAccess from '@nest-datum-ui/sso/components/Select/Access';
...
let Reference = ({ storeName }) => {
	...
	const accessId = useSelector(selectorMainExtract([ 'api', 'form', entityId, 'accessId' ]));
	const errorAccessId = useSelector(selectorMainExtract([ 'api', 'form', entityId, 'errors', 'accessId' ]));
	...
	const onChangeAccessId = React.useCallback((e) => {
		actionApiFormProp(entityId, 'accessId', e.target.value)();
	}, [
		entityId,
	]);

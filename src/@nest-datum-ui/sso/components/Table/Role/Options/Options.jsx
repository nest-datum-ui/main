...
let Options = ({
	...
	const onDelete = React.useCallback((roleId) => (e) => {
		actionDialogOpen('ssoRoleReferenceDrop', {
			roleId,
			optionId: entityId,
							...
							{data.map((item, index) => {
								return <TableRow key={item.id}>
									...
									<TableCell sx={{ width: '1%' }}>
										<IconButton onClick={onDelete(item['roleRoleOptions'][0]['id'])}>

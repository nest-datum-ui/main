...
import FormFilterTemplateStatus from './Status';
		...
		<Box 
			...
			<Grid
				...
				<Grid
					...
					lg={3}
					xl={2}>
					<FormFilterIsDeleted storeName="mailTemplateList" />
				</Grid>
				<Grid
					item
					xs={12}
					...
					lg={3}
					xl={2}>
					<FormFilterIsNotDelete storeName="mailTemplateList" />
				</Grid>
			</Grid>
		</Box>
	</React.Fragment>;
